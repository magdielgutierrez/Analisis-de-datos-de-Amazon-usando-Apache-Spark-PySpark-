...
|[D.3 Creando tabla pr_products_standard_price](#D.3-Creando-tabla-de-productos)|REGEXP_EXTRACT , REGEXP_REPLACE,TRANSLATE, COL, CONCAT, LAST, JOIN|
...
### D.3 Creando tabla de productos
